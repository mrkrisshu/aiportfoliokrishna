    ...
    <div className="relative h-screen overflow-hidden">
      <div className="absolute top-6 right-8 z-51 flex flex-col-reverse items-center justify-center gap-1 md:flex-row">
        ...
        <div className="">
          <GithubButton
            ...
            label="Star"
            size={'sm'}
            repoUrl="https://github.com/mrkrisshu/aiportfoliokrishna"
          />
        </div>
      </div>
      ...
      <div className="container mx-auto flex h-full max-w-3xl flex-col">
        ...
        <a
          ...
          className="fixed right-3 bottom-0 z-10 mb-4 hidden cursor-pointer items-center gap-2 rounded-xl px-4 py-2 text-sm text-blue-600 hover:underline md:block"
        >
          @Krishna
        </a>
      </div>
