...
export function Presentation() {
  const profile = {
    ...
    description:
      "Hey 👋\nI'm Krishu also known as Sachin. I'm a developer specializing in AI at Bangalore. I've worked at Bhai.AR where I built multiple production projects. I'm Studying at Kristu Jayanti University in Bangalore. I'm passionate about AI, tech, Entrepreneurship and SaaS tech.",
    src: '/krishna-photo-white.png',
    fallbackSrc:
      'https://images.unsplash.com/photo-1610216705422-caa3fcb6d158?q=80&w=3560&auto=format&fit=crop&ixlib=rb-4.0.3',
  };

  const tags = ['AI', 'Developer', 'Bangalore', 'Biker', 'SaaS Builder'];
