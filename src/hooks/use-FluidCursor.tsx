...
const useFluidCursor = () => {
  ...
  // Return early if canvas doesn't exist
  if (!canvas) {
    console.warn('FluidCursor: Canvas element with id "fluid" not found');
    return;
  }
  ...
  // Return early if WebGL context couldn't be created
  if (!webglResult) {
    return;
  }
  ...
  function getWebGLContext(canvas) {
    ...
    if (!gl) {
      console.warn('FluidCursor: WebGL is not supported in this browser');
      return null;
    }
